...
const AddCandidate = () => {
    return (
          ...
          <div className="w-[151px] h-[45px] bg-[#4c989d] rounded-[15px] relative z-[2] mt-[809px] mr-0 mb-0 ml-[432px]">
          ...
          <div className="w-[432px] h-[643px] absolute top-0 left-0 z-[45]">
            <div className="w-[96px] h-[32px] bg-transparent rounded-[50px] border-solid border-2 border-[#4c989d] relative z-[45] mt-0 mr-0 mb-0 ml-0">
              <div className="w-[31.25%] h-[93.75%] bg-[url('../assets/images/0174378a-c2f3-4c6a-9b99-4de76cf4d997.png')] bg-cover bg-no-repeat absolute top-[-3.13%] left-[-2.08%] z-[43]" />
              <span className="flex h-[27px] justify-start items-start font-['Poppins'] text-[18px] font-normal leading-[27px] text-black absolute top-0 left-[35px] text-left whitespace-nowrap z-[44]">
                Back
              </span>
            </div>
            <div className="w-[361px] h-[56px] bg-[rgba(76,152,157,0.38)] rounded-[10px] relative shadow-md z-[5] mt-[108px] mr-0 mb-0 ml-[71px]">
            ...
            <div className="w-[361px] h-[56px] bg-[rgba(76,152,157,0.38)] rounded-[10px] relative shadow-md z-[23] mt-[56px] mr-0 mb-0 ml-[71px]">
            ...
            <div className="w-[361px] h-[56px] bg-[rgba(76,152,157,0.38)] rounded-[10px] relative shadow-md z-[13] mt-[55px] mr-0 mb-0 ml-[71px]">
              <input className="w-full h-full bg-transparent border-none absolute top-0 left-0 z-[14]" />
            </div>
            <div className="w-[361px] h-[56px] bg-[rgba(76,152,157,0.38)] rounded-[10px] relative shadow-md z-[19] mt-[56px] mr-0 mb-0 ml-[71px]">
              <input className="w-full h-full bg-transparent border-none absolute top-0 left-0 z-[21]" />
            </div>
            <div className="w-[361px] h-[56px] bg-[rgba(76,152,157,0.38)] rounded-[10px] relative shadow-md z-[16] mt-[56px] mr-0 mb-0 ml-[71px]">
          ...
          <div className="w-[1038px] h-[720px] absolute top-[46px] left-0 z-[39]">
            <div className="w-[361px] h-[56px] bg-[rgba(76,152,157,0.38)] rounded-[10px] relative shadow-md z-[35] mt-[311px] mr-0 mb-0 ml-[595px]">
            ...
            <div className="w-[361px] h-[56px] bg-[rgba(76,152,157,0.38)] rounded-[10px] relative shadow-md z-[26] mt-[58px] mr-0 mb-0 ml-[595px]">
            ...
            <div className="w-[361px] h-[183px] bg-[rgba(76,152,157,0.38)] rounded-[10px] relative shadow-md z-[32] mt-[56px] mr-0 mb-0 ml-[595px]">
            ...
            <span className="flex h-[36px] justify-start items-start font-['Poppins'] text-[24px] font-semibold leading-[36px] text-[#4c989d] absolute top-0 left-[426px] text-center whitespace-nowrap z-[7]">
              Add Candidate
            </span>
            ...
            <div className="w-[163px] h-[166px] bg-[rgba(76,152,157,0.38)] rounded-[10px] absolute top-[80px] left-[687px] shadow-[4px_4px_4px_0_rgba(0,0,0,0.25)] z-[38]" />
            <span className="flex h-[16px] justify-start items-start font-['Karla'] text-[14px] font-normal leading-[16px] text-black absolute top-[193px] left-[728px] text-left whitespace-nowrap z-[39]">
              Upload Image
            </span>
          </div>
        </div>
