      ...
      <div className="flex flex-wrap justify-start gap-10">
        ...
        <div className="card mb-3 task-card relative rounded-[19px] p-2 shadow-lg bg-white ml-4">
          <div className="flex items-center justify-between">
            <b className="text-[16px] ml-3 mt-2 pl-2">Todo</b>
            ...
            <div className="flex justify-between mb-0 mt-1 pl-1 pr-1 relative">
              ...
              {openMenuIndex === index && (
                <div className="absolute bottom-0 right-0 mb-8 mr-4 bg-white border rounded shadow-lg">
                  <button className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={() => handleStatusChange('In Progress')}>
                    In Progress
                  </button>
                  <button className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={() => handleStatusChange('Completed')}>
                    Completed
                  </button>
                </div>
              )}
