  ...
  return (
    <div className="bg-bgfirst w-[100vw] min-h-screen flex justify-center items-center">
      ...
      <div className="flex justify-center mb-6">
        ...
        <h2 className="text-3xl text-center mb-4">New Organization</h2>
        <hr className="border-black mb-8" />
        <form onSubmit={handleSubmit} className="flex flex-wrap justify-between ">
          {/* Left side form fields (tablet and above) */}
          <div className="w-full lg:w-6/12 pl-2 pr-2">
            <div className="mb-6">
              <label htmlFor="organization_name" className="block text-lg mb-1">
                Organization Name
              </label>
              <input
                type="text"
            ...
            <div className="mb-6">
              <label htmlFor="organization_email" className="block text-lg mb-1">
                Organization Email
              </label>
              <input
                type="email"
              ...
              {errors.organization_email && (
                <span className="text-red-500">{errors.organization_email}</span>
              )}
            </div>

            <div className="mb-6">
              <label htmlFor="organization_website" className="block text-lg mb-1">
              ...
              {errors.organization_website && (
                <span className="text-red-500">{errors.organization_website}</span>
              )}
            </div>

            <div className="mb-6">
              <label htmlFor="organization_address" className="block text-lg mb-1">
              ...
              {errors.organization_address && (
                <span className="text-red-500">{errors.organization_address}</span>
              )}
            </div>
          </div>
          ...
          <div className="w-full lg:w-6/12 pl-2 pr-2">
            <div className="mb-6">
              <label htmlFor="owner_name" className="block text-lg mb-1">
                Owner Name
              </label>
              <input
                type="text"
            ...
            <div className="mb-6">
              <label htmlFor="owner_email" className="block text-lg mb-1">
                Owner Email
              </label>
              <input
                type="email"
            ...
            <div className="mb-6">
              <label htmlFor="owner_number" className="block text-lg mb-1">
                Owner Mobile Number
              </label>
              <input
                type="tel"
