...
//       </div>
//       <div className="absolute bottom-4 right-4 rounded-full pl-2 pr-2 text-[25px] text-white bg-[#4D989D]">
//           New Project
      ...
      <div className="card mb-3 project-card top-8 relative rounded-[19px] shadow-lg bg-gray-200 max-w-[350px] p-3">
        ...
        <div className="flex items-center ">
          <img
            ...
            className="project-img mt-6 w-[50px] mr-4"
          />
          <b className="text-xl font-serif pt-5 ml-[1px]">
            {project.proj_name}
          </b>
        </div>
        <p className="desc text-md font-serif p-3 text-justify">
        ...
        <p className="status text-[14px] font-serif p-3">
          Status: {project.status}
        </p>
      </div>
      <div className="absolute bottom-[-70px] right-4 rounded-full pl-2 pr-2 text-[25px] text-white bg-[#4D989D] flex items-center">
        <span className="m-2">New Project</span>
        <img src={PlusIcon} alt="PlusIcon" className="m-2 mb-0 ml-2" />
      </div>
    </div>
  );
};
