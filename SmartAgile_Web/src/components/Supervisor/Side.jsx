...
const Side = () => {
  const navItems = [
    { name: "Dashboard", icon: faChartBar, path: "/sdashboard" },
    { name: "Projects", icon: faBriefcase, path: "/sprojects" },
    { name: "Employees", icon: faTasks, path: "/employees" },
    { name: "Settings", icon: faCog, path: "/ssettings" },
  ];
